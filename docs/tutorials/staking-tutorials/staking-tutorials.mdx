...
sidebar_position: 1
description: This tutorial will explain how to delegate/stake/unstake your MIX.
---


Note: You can only stake MIX which is on Mix network. Please make sure you have changed into Mix network in Metamask while doing any transactions on staking UI.

How to Stake Fuse:

**Step 1:**

Navigate to stakingv2.miexs.com and connect to your wallet through MetaMask. Make sure you are on the Mix network.

![](/img/Pasted_Image_21_05_2023__13_28.jpg)
...
You will also see the APY on staking when you enter the amount of MIX you want to stake.
