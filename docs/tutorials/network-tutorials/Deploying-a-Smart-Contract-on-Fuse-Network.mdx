---
title: Deploying a Smart Contract on Mix Network
sidebar_position: 3
---

Mix Network is an EVM compatible blockchain, every tool for Ethereum can be used for the Mix network too.
...
Since we interact with remix using Metamask, you need to change the network to Mix network by adding a custom RPC.

You need to have a small balance of MIX on the Fusenet wallet you are using which will be used as Gas for the transactions.
