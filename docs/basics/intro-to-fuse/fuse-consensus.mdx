...
Those users are referred to as 'delegators.' A delegator is free to choose any validator (or validators) and stake any amount of MIX with them to participate. The Mix Staking [platform](https://stakingv2.miexs.com) is the most convenient way to delegate MIX to a validator.&#x20;
