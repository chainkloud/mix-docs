---
title: Mix Payment Infrastructure
---

# Mix Payment Infrastructure
...
If you are a developer or a business wishing to research or implement web3 payments, Mix's current infrastructure stack is described in more technical detail in the [Mix Stack](../../developers/fuse-sdk/architecture.mdx) section.
