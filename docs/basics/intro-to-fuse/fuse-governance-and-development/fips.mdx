...
FIP stands for Fuse Improvement Proposal. A FIP is a design document providing information to the Fuse community or describing a new feature for Mix Network. The FIP should provide motivation and technical specifications for the feature.
...
| [FIP-8](https://github.com/fuseio/FIPs/blob/master/FIPS/fip-8.md) |  Adjusting Block Rewards by the Validator's Stake            | [Done](https://github.com/chainkloud/mix-network/pull/61) |
