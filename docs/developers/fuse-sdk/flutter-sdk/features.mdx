...
### Transfer ERC20 Token/ Native MIX
...
For more code examples on using the Mix Wallet SDK for Flutter, you can check out the official [**Flutter SDK repository**](https://github.com/fuseio/smart\_wallets\_sdk/tree/master/example).
