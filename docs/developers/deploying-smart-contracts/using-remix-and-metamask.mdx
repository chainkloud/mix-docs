...
![](/img/image(21).png)
<p>Select the Metamask Account you want to connect. Make sure you selected Mix Network in the Metamask Network option.</p>

![](/img/image(26).png)
<p>Click Connect to link your Remix IDE to Metamask with Mix network connection.</p>

![](/img/connected-remix.png)
<p>Remix IDE is successfully connected to Metamask with Mix Network connection.</p>

### Compiling your contract in Remix <a href="#compiling-your-contract-in-remix" id="compiling-your-contract-in-remix"></a>

![](/img/image(13).png)
<p>Compiling a smart contract on Mix Network</p>

### Deploying your Contract <a href="#deploying-your-contract" id="deploying-your-contract"></a>

![](/img/image.png)<p>Deploying your smart contract on Mix Network</p>
