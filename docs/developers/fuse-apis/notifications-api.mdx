...
>
> Note that you will need to have an active Mix account and a project with Public and Secret API keys before getting started. Please refer to [Getting Started](../fuse-sdk/getting-started.mdx) before the next steps.
