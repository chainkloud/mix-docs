---
title: Mix Token On Other Chains
---
# Mix Token on Other Chains

Mix Token (MIX) is the native token on the Mix Network. Its official versions also exist on the following Layer-1 and 2 networks via the following ERC20 or ERC20-compatible smart contracts:
