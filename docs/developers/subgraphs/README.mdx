...
* The Graph is available on the Mix Network via the [Hosted Service](the-graph-hosted-service.mdx)
...
* [fuse-nft](https://thegraph.com/hosted-service/subgraph/fuseio/fuse-nft-v2) - all NFTs on the Mix Network
...
* [fuse-ethereum-amb](https://thegraph.com/hosted-service/subgraph/fuseio/fuse-to-ethereum-amb) - subgraph for Mix -> Ethereum AMB bridge
* [etherem-fuse-amb](https://thegraph.com/hosted-service/subgraph/fuseio/ethereum-to-fuse-amb) - subgraph for Ethereum -> Mix AMB bridge
