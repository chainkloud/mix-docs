...
To open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://miexs.com/address/0x4c889f137232E827c00710752E86840805A70484) with the following params:
...
Some other useful functions of the [voting contract](https://miexs.com/address/0x4c889f137232E827c00710752E86840805A70484) are:
