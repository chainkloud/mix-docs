...
After running the script successfully, you will see your address on the [health](https://status.miexs.com/) site.
\:::
...
You can see that you are validating both on the[ health](https://status.miexs.com) site
\:::
