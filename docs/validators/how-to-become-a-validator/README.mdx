...
* See *[Running a validator node](getting-started-as-a-validator-on-fuse-mainnet.mdx)*\_\_
...
[You can delegate your Mix token to a validator](../participating-in-network-consensus/stake-delegate-and-withdraw.mdx) of your choosing. Not everybody that wants to earn rewards needs to be a validator! Any token holder can delegate their Mix token to a validator to earn rewards through the validator.
