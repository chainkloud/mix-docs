---
title: Getting Started As A Validator On Mix Mainnet
sidebar_position: 2
---
...
* You have at least 100K MIX tokens, or you will have an aggregated delegation of at least 100K MIX tokens (you can purchase MIX tokens on [Uniswap](https://v2.info.uniswap.org/token/0x970b9bb2c0444f5e81e9d0efb84c8ccdcdcaf84d)).
* You have an always-on hardware that meets the pre-requisites -[ How to run network nodes](../../developers/run-or-access-fuse-nodes.mdx)
...
You can see that you are validating both in the [health](https://status.miexs.com/) and explorer sites.
\:::
