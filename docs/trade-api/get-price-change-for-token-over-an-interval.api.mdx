...
api:
  ...
  parameters:
    ...
    - name: timeFrame
      ...
      schema:
        type: string
      required: true
      description: 'How far to look back. Allowed values: "ALL","MONTH","WEEK","DAY","HOUR"'
      example: ALL
    - name: tokenAddress
      in: path
      schema:
  ...
  info:
    ...
    version: 1.0.0
  postman:
    name: Get Price Change for Token Over An Interval
    description:
      type: text/plain
    url:
      path:
      ...
      variable:
        - disabled: false
          description:
            content: >-
              (Required) How far to look back. Allowed values:
