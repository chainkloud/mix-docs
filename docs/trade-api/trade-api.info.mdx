...
id: trade-api
title: Trade API
description: Learn more about Trade API
...
Before working with Trade API, if you haven't done so, please follow the guide [Getting Started](developers/fuse-sdk/getting-started.mdx).
